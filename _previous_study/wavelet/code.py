...
input_csv = '/home/fauli/Bureau/reading seminar/donnée/data/T24S12-04_E-AL3479.csv'
...
output_dir = '/home/fauli/Bureau/reading seminar/wavelet/results/denoised_plots2'
...
for capteur in df.columns:
    ...
    filename = os.path.join(output_dir, f"{capteur}_denoised2.png")
    plt.savefig(filename)
    plt.close()
output_csv = "/home/fauli/Bureau/reading seminar/wavelet/results/donnée_denoised2.csv"  
